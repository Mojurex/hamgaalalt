...
const DEFAULT_DB_NAME = process.env.MONGODB_DB_NAME || 'school_support';
...
export async function connectDB() {
  ...
  if (!MONGODB_URI) {
    const message = 'Please define the MONGODB_URI environment variable (missing in process.env).';
